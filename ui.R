                        ...
                        fluidRow(
                          ...
                          column(3,
                                 wellPanel(
                                   ...
                                   checkboxInput("calc", "Generate Nameplate Peak Power-NPP(Kwpac) using the poped box"),
                                   conditionalPanel(condition = "input.calc == 0",
                                                    numericInput("nominal", "Installed Nameplate Peak Power(KWp)*", value = 26)),
             ...
             tabPanel(value = "dashboard", title = h4("Site Dashboard", style = "font-size: 16px; font-family:'Roboto'"),
                      ...
                      fluidPage(
                        fluidRow(
                          ...
                          column(width = 5,
                                 p("Montly Energy Output and comparison with solaR Simulation ", align = "center",
                                   style = "font-family:'Roboto';font-weight:bold;font-size: 15px"),
                                 br(),
                        ...
                        fluidRow(
                          column(4,
                                 ...
                                 p("2. The Demo Site is E.W. Brown Station, real-time field data is achieve from",
                                   tags$a(href = "https://lge-ku.com/our-company/community/neighbor-neighbor/ew-brown-generating-station", "Company Website")),
                                 p("3. The Montly Energy Output was calculated using field-record Meteo data (G0 and Ta)"),
                                 p("4. The Predication of Three-day-ahead Meteo data was obtained from",
                                   tags$a(href = "https://solcast.com/solar-data-api/", "Solcast"),
                                   "; the enenrgy output predication is calculated using Solcast meteo data and solaR"),
